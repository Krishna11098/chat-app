  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <p className="text-center text-gray-600 mb-6">Sign up to start chatting</p>
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition text-gray-900"
              value={name}
